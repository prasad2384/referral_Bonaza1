...
@section('title', 'Referee Edit Profile');
@section('style')
    .errors{
    font-weight:bold;
    color:red;
...
@section('content')
    <div class="container mt-5 pt-5 ">
        <form id="submit_form" method="POST" action="{{url('referee/update_profile/'.$data->id)}}" enctype="multipart/form-data">
            @csrf
            @method('POST')
            <div class="row p-5">
                @if ($data->logo)
                ...
                <div class="col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="firstname" value="{{ $data->firstname }}" class="form-control" id="">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group mb-3">
