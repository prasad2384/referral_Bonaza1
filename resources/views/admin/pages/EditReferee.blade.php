    ...
    <div class="container-fluid">
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title float-left mt-1">Update Referee</h3>
            </div>
            <div class="card-body">
                <form id="submit_form" action="{{url('admin/referee/'. $data->id)}}" method="POST" enctype="multipart/form-data" data-id="{{ $data->id }}">
                    @csrf
                    @method('PUT')
                    @if ($data->logo)
