...
<section class="content mt-3">
    <div class="container-fluid">
        <div class="card card-primary">
            ...
            <div class="card-body">
                <form id="Referral_form" method="POST" action="{{url('admin/referral_links/'.$data->id)}}" enctype="multipart/form-data" data-id="{{ $data->id }}">
                    @csrf
                    @method('PUT')
                    @if ($data->logo)
                    ...
                    <div class="row">
                        <div class=" col-sm-6">
                            <div class="form-group">
                                ...
                                <select name="category_id" class="form-control" id="category_id">
                                    ...
                                    <option value="{{ $cat->id }}" {{ $cat->id == $data->category_id ? 'selected' : '' }}>{{ $cat->name }}
                                    </option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class=" col-sm-6">
                            <div class="form-group">
                                ...
                                <select name="user_id" class="form-control" id="user_id">
                                    ...
                                    <option value="{{ $user->id }}" {{ $user->id == $data->user_id ? 'selected' : '' }}>{{ $user->username }}
                                    </option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class=" col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="url" name="referral_url" id="referral_url" class="form-control" placeholder="Enter Url" value="{{ $data->referral_url }}">
                            </div>
                        </div>
                        <div class=" col-sm-6">
                            <div class="form-group">
                                <label>Website Name</label>
                                <input type="text" name="display_name" id="display_name" class="form-control" placeholder="Enter Website Name" value="{{ $data->display_name }}">
                            </div>
                        </div>
                        <div class=" col-sm-6">
                            <div class="form-group">
                                <label>Canonicalized Name</label>
                                <input type="text" name="canonicalized_name" id="canonicalized_name" class="form-control" placeholder="Enter Canonicalized Name" value="{{ $data->canonicalized_name }}">
                            </div>
                        </div>
                        <div class=" col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="custom-file">
                                    <input type="file" class="form-control p-1" name="logo" class="custom-file-input" id="logo">
                                </div>
                            </div>
                        </div>
                        <div class=" col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="promo_terms" id="promo_terms" class="form-control" placeholder="Enter Promo Terms" value="{{ $data->promo_terms }}">
                            </div>
                        </div>
                        <div class=" col-sm-6">
                            <div class="form-group">
                                <label>Promo Url</label>
                                <input type="url" name="promo_terms_url" id="promo_terms_url" class="form-control" placeholder="Enter Promo Url" value="{{ $data->promo_terms_url }}">
                            </div>
                        </div>
                        <div class=" col-sm-6">
                            <div class="form-group">
                                <label>Promo Expiration Date</label>
                                <input type="date" name="promo_expiration_date" id="promo_expiration_date" class="form-control" placeholder="Enter Promo Url" value="{{ $data->promo_expiration_date }}">
                            </div>
                        </div>
                        <div class=" col-sm-6">
                            <div class="form-group">
                                <label>Expected Payout</label>
                                <input type="number" name="expected_payout" id="expected_payout" class="form-control" placeholder="Enter Payout" value="{{ $data->expected_payout_by_referar }}">
                            </div>
                        </div>
                        <div class=" col-sm-6">
                            <div class="form-group">
                                ...
                                <select name="offer_id" class="form-control" id="offer_id">
                                    ...
                                    <option value="{{ $website_data->id }}" {{ old('user_id', $data->offer_id) == $website_data->id ? 'selected' : '' }}>
                        ...
                        <div class=" col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="referee_share_percentage" id="referee_share_percentage" class="form-control" placeholder="Enter Referee Payout" value="{{ $data->referee_share_percentage }}">
                            </div>
                        </div>
                        <div class=" col-sm-6">
                            <div class="form-group">
                                <label>Referral Share Percentage</label>
                                <input type="number" name="referral_share_percentage" id="referral_share_percentage" class="form-control" placeholder="Enter Referral Payout" value="{{ $data->referral_share_percentage }}">
                            </div>
                        </div>
                        <div class=" col-sm-6">
                            <div class="form-group">
                                <label>Platform Percentage</label>
                                <input type="number" name="platform_percentage" id="platform_percentage" class="form-control" placeholder="Enter Platform Payout" value="{{ $data->platform_percentage }}">
                            </div>
                        </div>
                        <div class=" col-sm-6">
                            <div class="form-group">
                                <label>Expected Days</label>
                                <input type="number" name="expected_days" id="expected_days" class="form-control" placeholder="Enter Expected Days" value="{{ $data->expected_days }}">
                            </div>
                        </div>
                        <div class=" col-sm-6">
                            <div class="form-group">
